...
export function Synthwave80s() {
  return (
    <div className="relative min-h-[900px] w-full overflow-hidden bg-[#0b001a] text-white font-sans selection:bg-[#FF00CC] selection:text-white">
      {/* Google Fonts */}
      ...
      <div className="absolute inset-0 z-0 flex flex-col justify-end overflow-hidden">
        ...
        <div 
          className="absolute inset-0 opacity-60 z-0 bg-center bg-cover bg-no-repeat"
      ...
      {/* Content Container */}
      <div className="relative z-10 mx-auto max-w-7xl px-6 h-full min-h-[900px] flex flex-col">
        {/* Navigation */}
        ...
        {/* Main Hero Content */}
        <div className="flex-1 flex flex-col justify-center mt-[-80px]">
          
          <div className="inline-flex items-center gap-3 mb-6 bg-[#00000080] border border-[#00FFF0] px-4 py-2 self-start rounded-none backdrop-blur-sm shadow-[0_0_10px_#00FFF0]">
          ...
          <h1 
            className="text-6xl md:text-8xl lg:text-[7rem] font-black uppercase leading-tight mb-6"
            style={{ 
              fontFamily: "'Audiowide', cursive",
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-2xl mb-12 uppercase tracking-widest leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]" style={{ fontFamily: "'Outfit', sans-serif" }}>
          ...
          {/* Benefits Panel */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mt-auto pb-12">
            {[
              ...
              <div 
                key={i}
                className="flex items-center gap-4 bg-[#1a0033]/80 border border-[#FF00CC]/50 p-4 backdrop-blur-md shadow-[0_0_15px_rgba(255,0,204,0.2)]"
                style={{ fontFamily: "'Outfit', sans-serif" }}
              >
                <div className="text-2xl drop-shadow-[0_0_5px_#00FFF0]">{benefit.icon}</div>
                <div className="text-sm font-bold tracking-widest text-[#00FFF0] uppercase">
                  {benefit.title}
                </div>
              </div>
            ))}
