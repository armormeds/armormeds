...
WellnessMeds is a telehealth platform for weight management medications. It's a lead generation website where users can browse GLP-1 medications (like Semaglutide and Tirzepatide), learn about the service, and submit inquiry forms to connect with licensed providers. The application follows a modern full-stack architecture with a React frontend and Express backend.
...
- **Tables**: 
  - `products` - medication listings (name, description, price, image, benefits)
  - `leads` - customer inquiries (name, email, phone, medication interest, message, status)
...
client/           # React frontend
  src/
    ...
    pages/        # Route pages (Home, Medications, GetStarted, About)
